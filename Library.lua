...
local Library = {
    ...
    IsLightTheme = false,
    Scheme = {
        BackgroundColor = Color3.fromRGB(10, 11, 13),
        MainColor = Color3.fromRGB(22, 24, 27),
        ElementColor = Color3.fromRGB(38, 41, 46),
...
function Library:CreateWindow(WindowInfo)
    ...
    local function ApplyCompact()
        ...
        for _, Button in Library.TabButtons do
            ...
            Button.Button.Size = UDim2.new(1, 0, 0, IsCompact and WindowInfo.SidebarCompactWidth - 12 or 40)
    ...
    function Window:AddTab(...)
        ...
        do
            TabButton = New("TextButton", {
                BackgroundColor3 = "MainColor",
                BackgroundTransparency = 1,
                Size = UDim2.new(1, 0, 0, IsCompact and WindowInfo.SidebarCompactWidth - 12 or 40),
                Text = "",
                LayoutOrder = Order,
                Parent = Tabs,
            })
        ...
        function Tab:AddGroupbox(Info)
            ...
            function Groupbox:Resize()
                ...
                local TargetSize = UDim2.new(1, 0, 0, if Groupbox.Collapsed then 34 else (GroupboxList.AbsoluteContentSize.Y / Library.DPIScale) + 59)
